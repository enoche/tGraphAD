...
A curated list of recent awesome graph-based anomaly detection resources from 2020 (***Only list papers with code***). Please contact us if your work is not in the list.  
